import { clearTicketsArray, addTicketsToArray} from './dataAction'
...
export const getTicketsAndAplyFilter = (condition, dispatch) => {
    dispatch(setFetching(true));
    dispatch(clearTicketsArray());
    serverAPI.getSearchId()
        .then((response) => { reciveStreamTickets(response.data.searchId, dispatch, condition) })
}
